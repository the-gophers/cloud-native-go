...
var roleAssignmentDeploymentKubernetesDefinition = 'KubernetesServiceClusterUserRole'
resource roleAssignmentDeploymentKubernetes 'Microsoft.Authorization/roleAssignments@2020-08-01-preview' = {
  name: guid(managedIdentityDeploy.id, roleAssignmentDeploymentKubernetesDefinition)
  scope: aks
  properties: {
    roleDefinitionId: subscriptionResourceId('Microsoft.Authorization/roleDefinitions', roleDefinitionId[roleAssignmentDeploymentKubernetesDefinition])
    principalId: managedIdentityDeploy.properties.principalId
  }
  dependsOn: [
    managedIdentityDeploy
